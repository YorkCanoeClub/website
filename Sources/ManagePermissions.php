	...
	*/
	$permissionList = array(
		'membergroup' => array(
			...
			// start ForumFirewall
			'forumfirewall_goodgroup' => array(false, 'general', 'view_basic_info'),
			// end ForumFirewall

                        // YCC Member List
			'view_ownylist' => array(false, 'ylist', 'ycc_memberlist'),
                        'view_ylist' => array(false, 'ylist', 'ycc_memberlist'),
			'manage_ylist' => array(false, 'ylist', 'ycc_memberlist'),
                    
			// Committee Pages
                        'committee' => array(false, 'committee', 'committee'),
                        'committee_manage' => array(false, 'committee', 'committee'),

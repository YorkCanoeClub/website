...
<head>';
	...
	// ]]></script>';
        ...
        <script src="/libraries/jquery-ui-1.10.0.custom/jquery-ui-1.10.0.custom/js/jquery-ui-1.10.0.custom.min.js"></script>
        <script src="/libraries/DataTables-1.9.4/media/js/jquery.dataTables.min.js"></script>
...
function template_body_below()
{
	...
	<div id="footer_section"><div class="frame">
		<ul class="reset">
			<li class="copyright">', theme_copyright(), FFCopyright(), '</li>

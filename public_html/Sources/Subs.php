...
function setupMenuContext()
{
	...
	if (($menu_buttons = cache_get_data('menu_buttons-' . implode('_', $user_info['groups']) . '-' . $user_info['language'] . '-' . empty($context['disable_sp']), $cacheTime)) === null || time() - $cacheTime <= $modSettings['settings_updated'])
	{
		$buttons = array(
			...
			'search' => array(
				...
				'show' => false, //$context['allow_search'],
				'sub_buttons' => array(
				),
			),
			'profile' => array(
			...
			'mlist' => array(
				...
				'sub_buttons' => array(
					...
					'mlist_search' => array(
                        ...
                        'ynewmember' => array(
                                'title' => 'Join YCC',
                                'href' => $scripturl . '?action=ynewmember',
                                'show' => true,
                        ),
                        'ymembership' => array(
                                'title' => 'Your Memberships',
                                'href' => $scripturl . '?action=ymembership',
                                'show' => !$user_info['is_guest'],
                        ),
                    	'cwaiting' => array(
				'title' => 'Waiting List',
				'href' => $scripturl . '?action=cwaiting',
				'show' => allowedTo(array('committee'))
			),
                        'ywaiting' => array(
                                'title' => 'Waiting List',
                                'href' => $scripturl . '?action=ywaiting',
                                'show' => !$user_info['is_guest'] && !allowedTo(array('committee')),
                        ),
                        'ylist' => array(
				'title' => 'Member List',
				'href' => $scripturl . '?action=ylist',
				'show' => allowedTo(array('committee'))
			),
                        'login' => array(
				'title' => $txt['login'],
                                ...
                                'sub_buttons' => array(
                                            'portalconfig' => array(
                                                    ...
                                                    'sub_buttons' => array(
                                                            'portalconfig1' => array(
                                                                    'title' => 'Information',
                                                                    'href' => $scripturl . '?action=admin;area=portalconfig;sa=information',
                                                                    'show' => allowedTo(array('sp_admin', 'sp_manage_settings')),
                                                                    'sub_buttons' => array(),
                                                            ),
                                                            'portalconfig2' => array(
                                                                    'title' => 'General Settings',
                                                                    'href' => $scripturl . '?action=admin;area=portalconfig;sa=generalsettings',
                                                                    'show' => allowedTo(array('sp_admin', 'sp_manage_settings')),
                                                                    'sub_buttons' => array(),
                                                            ),
                                                            'portalconfig3' => array(
                                                                    'title' => 'Block Settings',
                                                                    'href' => $scripturl . '?action=admin;area=portalconfig;sa=blocksettings',
                                                                    'show' => allowedTo(array('sp_admin', 'sp_manage_settings')),
                                                                    'sub_buttons' => array(),
                                                            ),
                                                            'portalconfig4' => array(
                                                                    'title' => 'Article Settings',
                                                                    'href' => $scripturl . '?action=admin;area=portalconfig;sa=articlesettings',
                                                                    'show' => allowedTo(array('sp_admin', 'sp_manage_settings')),
                                                                    'sub_buttons' => array(),
                                                                    'is_last' => true,
                                                            ),						
                                            ...
                                            'portalblocks' => array(
                                                    ...
                                                    'sub_buttons' => array(
                                                            'portalblocks1' => array(
                                                                    'title' => 'Block List',
                                                                    'href' => $scripturl . '?action=admin;area=portalblocks;sa=list',
                                                                    'show' => allowedTo(array('sp_admin', 'sp_manage_blocks')),
                                                                    'sub_buttons' => array(),
                                                            ),
                                                            'portalblocks2' => array(
                                                                    'title' => 'Add Block',
                                                                    'href' => $scripturl . '?action=admin;area=portalblocks;sa=add',
                                                                    'show' => allowedTo(array('sp_admin', 'sp_manage_blocks')),
                                                                    'sub_buttons' => array(),
                                                                    'is_last' => true,
                                                            ),					
                                            ...
                                            'portalarticles' => array(
                                                    'title' => 'Portal Articles',
                                                    'href' => $scripturl . '?action=admin;area=portalarticles',
                                                    'show' => allowedTo(array('sp_admin', 'sp_manage_articles')),
                                                    'sub_buttons' => array(
                                                            'portalarticles1' => array(
                                                                    'title' => 'Article List',
                                                                    'href' => $scripturl . '?action=admin;area=portalarticles;sa=articles',
                                                                    'show' => allowedTo(array('sp_admin', 'sp_manage_articles')),
                                                                    'sub_buttons' => array(),
                                                            ),
                                                            'portalarticles2' => array(
                                                                    'title' => 'Add Article',
                                                                    'href' => $scripturl . '?action=admin;area=portalarticles;sa=addarticle',
                                                                    'show' => allowedTo(array('sp_admin', 'sp_manage_articles')),
                                                                    'sub_buttons' => array(),
                                                            ),
                                                            'portalarticles3' => array(
                                                                    'title' => 'Category List',
                                                                    'href' => $scripturl . '?action=admin;area=portalarticles;sa=categories',
                                                                    'show' => allowedTo(array('sp_admin', 'sp_manage_articles')),
                                                                    'sub_buttons' => array(),
                                                            ),
                                                            'portalarticles4' => array(
                                                                    'title' => 'Add Category',
                                                                    'href' => $scripturl . '?action=admin;area=portalarticles;sa=addcategory',
                                                                    'show' => allowedTo(array('sp_admin', 'sp_manage_articles')),
                                                                    'sub_buttons' => array(),
                                                                    'is_last' => true,
                                                            ),						
                                            ...
                                            'portalpages' => array(
                                                    ...
                                                    'sub_buttons' => array(
                                                            'portalpages1' => array(
                                                                    'title' => 'Page List',
                                                                    'href' => $scripturl . '?action=admin;area=portalpages;sa=list',
                                                                    'show' => allowedTo(array('sp_admin', 'sp_manage_pages')),
                                                                    'sub_buttons' => array(),
                                                            ),
                                                            'portalpages2' => array(
                                                                    'title' => 'Add Page',
                                                                    'href' => $scripturl . '?action=admin;area=portalpages;sa=add',
                                                                    'show' => allowedTo(array('sp_admin', 'sp_manage_pages')),
                                                                    'sub_buttons' => array(),
                                                                    'is_last' => true,
                                                            ),					
                                            ...
                                            'portalshoutbox' => array(
                                                    'title' => 'Portal Shoutbox',
                                                    'href' => $scripturl . '?action=admin;area=portalshoutbox',
                                                    'show' => allowedTo(array('sp_admin', 'sp_manage_shoutbox')),
                                                    'sub_buttons' => array(
                                                            'portalshoutbox1' => array(
                                                                    'title' => 'Shoutbox List',
                                                                    'href' => $scripturl . '?action=admin;area=portalshoutbox;sa=list',
                                                                    'show' => allowedTo(array('sp_admin', 'sp_manage_shoutbox')),
                                                                    'sub_buttons' => array(),
                                                            ),
                                                            'portalshoutbox2' => array(
                                                                    'title' => 'Add Shoutbox',
                                                                    'href' => $scripturl . '?action=admin;area=portalshoutbox;sa=add',
                                                                    'show' => allowedTo(array('sp_admin', 'sp_manage_shoutbox')),
                                                                    'sub_buttons' => array(),
                                                                    'is_last' => true,
                                                            ),					
                                            ...
                                            'adminmain' => array(
                                                    ...
                                                    'show' => allowedTo(array('allow_admin')),
                                                    'sub_buttons' => array(
                                                            'adminmain1' => array(
                                            ...
                                            'adminconfiguration' => array(
                                                    'title' => 'Forum Configuration',
                                                    'href' => $scripturl . '?action=admin;area=corefeatures',
                                                    'show' => allowedTo(array('allow_admin')),
                                                    'sub_buttons' => array(
                                                            'adminconfiguration1' => array(
                                                                    'title' => 'Core Features',
                                                                    'href' => $scripturl . '?action=admin;area=corefeatures',
                                                                    'show' => allowedTo(array('allow_admin')),
                                                                    'sub_buttons' => array(),
                                                            ),							
                                                            'adminconfiguration2' => array(
                                                                    'title' => 'Features & Options',
                                                                    'href' => $scripturl . '?action=admin;area=featuresettings',
                                                                    'show' => allowedTo(array('allow_admin')),
                                                                    'sub_buttons' => array(),
                                                            ),
                                                            'adminconfiguration3' => array(
                                                                    'title' => 'Security & Moderation',
                                                                    'href' => $scripturl . '?action=admin;area=securitysettings',
                                                                    'show' => allowedTo(array('allow_admin')),
                                                                    'sub_buttons' => array(),
                                                            ),
                                                            'adminconfiguration4' => array(
                                                                    'title' => 'Languages',
                                                                    'href' => $scripturl . '?action=admin;area=languages',
                                                                    'show' => allowedTo(array('allow_admin')),
                                                                    'sub_buttons' => array(),
                                                            ),
                                                            'adminconfiguration5' => array(
                                                                    'title' => 'Server Settings',
                                                                    'href' => $scripturl . '?action=admin;area=serversettings;sesc=' . $context['session_id'],
                                                                    'show' => allowedTo(array('allow_admin')),
                                                                    'sub_buttons' => array(),
                                                            ),
                                                            'adminconfiguration6' => array(
                                                                    'title' => 'Current Theme',
                                                                    'href' => $scripturl . '?action=admin;area=theme;sa=settings;th=1',
                                                                    'show' => allowedTo(array('allow_admin')),
                                                                    'sub_buttons' => array(),
                                                            ),
                                                            'adminconfiguration7' => array(
                                                                    'title' => 'Themes & Layout',
                                                                    'href' => $scripturl . '?action=admin;area=theme;sa=admin',
                                                                    'show' => allowedTo(array('allow_admin')),
                                                                    'sub_buttons' => array(),
                                                            ),
                                                            'adminconfiguration8' => array(
                                            ...
                                            'adminforum' => array(
                                                    ...
                                                    'sub_buttons' => array(
                                                            ...
                                                            'adminforum3' => array(
                                                                    'title' => 'Calendar',
                                                                    'href' => $scripturl . '?action=admin;area=managecalendar',
                                                                    'show' => allowedTo(array('allow_admin')),
                                                                    'sub_buttons' => array(),
                                                            ),
                                                            'adminforum4' => array(
                                                            ...
                                                            'adminforum5' => array(
                                                                    'title' => 'Smileys & Message Icons',
                                                                    'href' => $scripturl . '?action=admin;area=smileys',
                                                                    'show' => allowedTo(array('allow_admin')),
                                                                    'sub_buttons' => array(),
                                                            ),
                                                            'adminforum6' => array(
                                                                    'title' => 'Attachements & Avatars',
                                                                    'href' => $scripturl . '?action=admin;area=manageattachments',
                                                                    'show' => allowedTo(array('allow_admin')),
                                                                    'sub_buttons' => array(),
                                                                    'is_last' => true,
                                                            ),
	...
	elseif ($context['current_action'] == '' && isset($_GET['page']) && substr($_GET['page'],0,8) == 'yccAbout')
		$current_action = 'yccAbout';
	elseif ($context['current_action'] == '' && isset($_GET['page']) && substr($_GET['page'],0,7) == 'yccJoin')
		$current_action = 'yccJoin';

...
function AdminMain()
{
	...
	$admin_areas = array(
		...
		'config' => array(
			...
			// ForumFirewall Start
			'forumfirewall' => array(
					'label' => $txt['forumfirewall'],
					'file' => 'ForumFirewall-Admin.php',
					'function' => 'forumfirewall_admin_init',
					'custom_url' => $scripturl . '?action=admin;area=forumfirewall;sa=settings',
					'permission' => array('admin_forum'),
					'icon' => 'modifications.gif',
					'subsections' => array(
						'forumfirewall_settings' => array($txt['forumfirewall_settings_title']),
						'forumfirewall_report_denied' => array($txt['forumfirewall_report_denied_title']),
						'forumfirewall_about' => array($txt['forumfirewall_about_title']),
					),
				),
				// ForumFirewall End
			'modsettings' => array(

...
$txt['maintain_recount_posts'] = 'Recount all member post counts';
$txt['maintain_recount_posts_info'] = 'Should the total post count of any member be altered, and you wish to set it back to its true value, run this task. It will recount the actual post count for all members.';$txt['maintain_errors'] = 'Find and repair any errors';
